...
bool Client::createAccount()
{
    ...
    if (choice == 'y')
    {
        this->account = new SavingsBankAccount(amount);
        return true;
    }
    else if (choice == 'n')
    {
...
BankAccount::BankAccount(double initialBalance)
{
    ...
    if(initialBalance < 1000) {
        cout << "Minimum balance must be 1000 L.E or greater\n";
...
void BankAccount::setBalance(double currentBalance)
{
    if (currentBalance > 0)
    {
...
SavingsBankAccount::SavingsBankAccount(double initialBalance) : BankAccount(initialBalance) {}
